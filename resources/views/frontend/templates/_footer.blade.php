            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="section-title-2 mt-25">
                        <h2 class="title">Ingin Menjadi Donatur.?</h2>
                        <span class="line"></span>
                        <p>Mari Kita Berlomba di Jalan Kebaikan Dengan Membantu Pemberdayaan Untuk Anak Yatim, Piatu, Fakir dan Miskin di Bidang Pendidikan</p>
                    </div>
                </div>
                <div class="col-lg-7">
